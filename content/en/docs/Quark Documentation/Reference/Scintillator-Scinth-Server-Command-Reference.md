...
<dd>Replies to sender with <strong>/scin_done</strong> just before completion.

</dl>
Query the status. Replies to sender with the following message:

<dl>
<dt>/scin_status.reply

<dd><table>
<tr><td><strong>int</strong>

</td><td>number of running Scinths.

</td></tr>
<tr><td><strong>int</strong>

</td><td>number of groups.

</td></tr>
<tr><td><strong>int</strong>

</td><td>number of loaded Scinth defintions.

</td></tr>
<tr><td><strong>int</strong>

</td><td>number of warnings in log.

</td></tr>
<tr><td><strong>int</strong>

</td><td>number of errors in log.

</td></tr>
<tr><td><strong>double</strong>

</td><td>approximate graphics memory consumed, in bytes.

</td></tr>
<tr><td><strong>double</strong>

</td><td>approximage graphics memory available, in bytes. Some graphics devices don't support this statistic, in which case it will be 0.

</td></tr>
<tr><td><strong>int</strong>

</td><td>target frame rate in frames per second (can be -1 or 0)

</td></tr>
<tr><td><strong>double</strong>

</td><td>computed mean framerate.

</td></tr>
<tr><td><strong>int</strong>

</td><td>number of dropped frames, if running real time, 0 otherwise.
...
</td><td>0 to disable logging. Nonzero to enable.
...
<dd>Replies to sender with <strong>/scin_synced, ID</strong> when complete.
...
<dl>
<dt>/scin_version.reply

<dd><table>
<tr><td><strong>string</strong>

</td><td>Program name. Will always be "scinsynth".

</td></tr>
<tr><td><strong>int</strong>

</td><td>Scintillator major version number.

</td></tr>
<tr><td><strong>int</strong>

</td><td>Scintillator minor version number.

</td></tr>
<tr><td><strong>int</strong>

</td><td>Scintillator patch version number.

</td></tr>
<tr><td><strong>string</strong>

</td><td>Git branch name.

</td></tr>
<tr><td><strong>string</strong>

</td><td>First seven hex digits of the commit hash.
...
</td><td>A string of yaml data containing one or more ScinthDef documents.

</td></tr>
<tr><td><strong>bytes</strong>

</td><td>optional, an OSC message to execute upon completion.
...
<dd>Replies to sender with <strong>/scin_done</strong> when complete.
...
</td><td>pathname of file to load.
...
</td><td>directory of *.yaml files to load.
...
<table>
<tr><td>N * <strong>string</strong>

</td><td>ScinthDef names to free.
...
<ul>
<li>if the run flag is set to zero then the node will not be rendered.

<li>if the run flag is set to any nonzero value then it will be rendered.
...
<tr><td><strong>int</strong> or <strong>string</strong>

</td><td>A control index or name

</td></tr>
<tr><td><strong>int</strong> or <strong>float</strong>

</td><td>A control value
...
</td><td>add action (not yet supported)

</td></tr>
<tr><td><strong>int</strong>

</td><td>add target ID (not yet supported)
...
</td><td>path to image file to decode

</td></tr>
<tr><td><strong>int</strong>

</td><td>width of image (can be -1 to respect width of source image)

</td></tr>
<tr><td><strong>int</strong>

</td><td>height of image (can be -1 to respect height of source image)
...
<table>
<tr><td><strong>width requested</strong>

</td><td><strong>height requested</strong>

</td><td><strong>buffer width</strong>

</td><td><strong>buffer height</strong>
...
</td><td>Server will disregard aspect ratio of source image if both requested dimensions are nonnegative.
...
</td><td>In order to maintain 2:1 aspect ratio server has computed a width of 50 px.
...
</td><td>In order to maintain 2:1 aspect ratio server has computed a height of 400 px.
...
</td><td>Server has allocated width and height of source image.
...
<dd>Replies to sender with <strong>/scin_done /scin_ib_readImage bufNum</strong> when complete.
...
</td><td>Image bufer number

</td></tr>
<tr><td><strong>int</strong>

</td><td>Image size in bytes, 0 if invalid

</td></tr>
<tr><td><strong>int</strong>

</td><td>Image width, -1 if invalid

</td></tr>
<tr><td><strong>int</strong>

</td><td>Image height, -1 if invalid
...
</td><td>file name and path to save the screenshot to.

</td></tr>
<tr><td><strong>string</strong>

</td><td>(optional) a mime type of the desired image file, to guide container and codec selection.
...
</td><td>numerator for fractional time advancement

</td></tr>
<tr><td><strong>int</strong>

</td><td>denominator for fractional time advancement
...
<dd>Replies to sender with <strong>/scin_done</strong> followed by <strong>/scin_nrt_advanceFrame</strong>.
...
</td><td>An OSC message to respond to the caller with.
...
<dd>Replies to the sender immediately with the provided message blob.
...
</td><td>A log level, from 0-6, to associate with this log entry. See the table in <strong>/scin_logLevel</strong> for the log levels.

</td></tr>
<tr><td><strong>string</strong>

</td><td>The string to place in the logs.
...
</td><td>The number of seconds to sleep for.
...
<dd>Replies to the sender on wakeup with <strong>/scin_awake</strong>.
